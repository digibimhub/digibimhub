...
import { bundleHeadline, licensingSummary, productName } from '@/lib/software-solutions'
      ...
      <section className="relative overflow-hidden bg-navy pb-10 pt-12 text-white sm:pt-14">
        ...
        <div className="container-max relative max-w-5xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-white/85 sm:text-base">
            {bundleHeadline}. Estimate annual time savings, cost savings, and return on investment for your BIM team.
          </p>
      ...
      <div className="section-padding bg-white">
        <div className="container-max max-w-5xl">
          ...
          <p className="mt-6 text-center text-xs text-navy/60">
            Illustrative per-user cost at 50 users: {licensingSummary.perUserCostNote}
          </p>
