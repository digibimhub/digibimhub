...
export const REVIT_ADDONS: RevitAddon[] = [
  {
    slug: 'smart-sheet-drawing-automation',
  ...
  {
    slug: 'bim-quantity-takeoff-estimation',
  ...
  {
    slug: 'clash-detection-coordination-assistant',
  ...
  {
    slug: 'revit-family-library-manager',
  ...
  {
    slug: 'bim-project-health-audit',
    title: 'BIM Project Health & Audit Tool',
    overview:
      'Analyzes Revit project performance, detects modeling issues, and improves file optimization.',
    features: [
  ...
  {
    slug: 'construction-progress-4d-bim',
    title: 'Construction Progress & 4D BIM Add-on',
    overview:
      'Connects project schedules with BIM models for visual construction tracking and planning.',
    features: [
...
export const CUSTOM_DEVELOPMENT_SERVICES = [
...
export const CUSTOM_DEVELOPMENT_IDEAL_FOR = [
  'Architecture Firms',
